import { r as copyText } from "./store-CrYC-xFx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/probe-file-D8XxSXQ3.js
function probeFileName(code) {
	return `scope-probe-${code}.html`;
}
function downloadProbeFile(code, filename = probeFileName(code)) {
...
async function saveProbeFile(code, filename = probeFileName(code)) {
	const html = buildProbeHtml(code);
...
//#endregion
export { probeFileName as n, saveProbeFile as r, buildProbeHtml as t };
